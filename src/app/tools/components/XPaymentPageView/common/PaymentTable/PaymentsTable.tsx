...
export const columns: ColumnDef<IPayment>[] = [
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div>
          <a
            href={`${network.explorerAddress}/transactions/${original.txHash}`}
            target='_blank'
            rel='noreferrer'
          >
            {' '}
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div>
        <a
          href={`${network.explorerAddress}/accounts/${row.getValue(
            'receiver'
          )}`}
          target='_blank'
          rel='noreferrer'
...

  {
    ...
    cell: ({ row }) => (
      <div>
        {' '}
        <a
          href={`${network.explorerAddress}/accounts/${row.getValue('sender')}`}
          target='_blank'
          rel='noreferrer'
        >
          {' '}
...
function PaymentsTable({ data }: { data: IPayment[]; isLoading: boolean }) {
